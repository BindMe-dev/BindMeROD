          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-slate-400 text-sm">Monitor agreements, disputes, and statuses.</p>
              </div>
              <Button
                variant="outline"
                size="sm"
            ...
            <Card className="bg-slate-900/80 border border-slate-800">
              ...
              <CardContent className="space-y-2 text-sm text-slate-300">
                <p>Surface global agreement states, disputes, and completion pipelines.</p>
                <div className="rounded-lg border border-slate-800 bg-slate-900/60 p-3">
                  <p className="text-xs text-slate-400">Hook into your Agreement table and dispute workflows here.</p>
                </div>
              </CardContent>
            </Card>
          </div>
